...
export default function PickupOrderShow({
    order,
    allowedTransitions,
    drivers,
    canRegisterPod,
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: `#${order.id}`, href: `/pickup-orders/${order.id}` },
    ];

    const handleAction = (action: string) => {
        setIsProcessing(true);
        router.post(
            `/pickup-orders/${order.id}/${action}`,
            {},
    ...
    const handleAssignDriver = () => {
        ...
        setIsProcessing(true);
        router.post(
            `/pickup-orders/${order.id}/assign-driver`,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-6">
                ...
                {/* POD Display */}
                {order.pod && <PodDisplay pod={order.pod} orderType="pickup" />}
            </div>
            ...
            <Dialog open={assignDialogOpen} onOpenChange={setAssignDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Seleccione un conductor para esta recogida
                        </DialogDescription>
                    </DialogHeader>
                    <div className="py-4">
