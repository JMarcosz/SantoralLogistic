...
export default function EditAccount({
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        parent_id: account.parent_id || ('' as string | number),
        is_postable: account.is_postable,
        requires_subsidiary: account.requires_subsidiary,
    ...
    // Filter only non-postable accounts for parent (headers only), excluding self
    const parentOptions = allAccounts.filter(
        (acc) => !acc.is_postable && acc.id !== account.id,
    );
