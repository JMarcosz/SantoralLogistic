...
class StoreQuoteRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'lines.*.product_service_id.required' => 'El producto/servicio es requerido.',
            'lines.*.quantity.required' => 'La cantidad es requerida.',
            'lines.*.quantity.gt' => 'La cantidad debe ser mayor a 0.',
            'lines.*.unit_price.required' => 'El precio unitario es requerido.',
            'lines.*.unit_price.gte' => 'El precio unitario no puede ser negativo.',
        ];
    }
    ...
    public function attributes(): array
    {
        return [
            'customer_id' => 'cliente',
            'origin_port_id' => 'puerto de origen',
            'destination_port_id' => 'puerto de destino',
            'transport_mode_id' => 'modo de transporte',
            'service_type_id' => 'tipo de servicio',
            'currency_id' => 'moneda',
            'valid_until' => 'válido hasta',
            'lines.*.product_service_id' => 'producto/servicio',
